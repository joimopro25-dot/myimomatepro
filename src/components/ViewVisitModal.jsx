 ...
 * UPDATED: Added "Create Offer from Visit" functionality (Option 1)
 */
...
export default function ViewVisitModal({ isOpen, onClose, visit, onCreateOffer }) {
  ...
  // NEW: Check if we can create an offer from this visit
  const canCreateOffer = () => {
    // Can create offer if visit is completed and has buyer info
    return visit.status === 'completed' && 
           (visit.visitorName || visit.visitorPhone || visit.visitorEmail);
  };

  // NEW: Handle create offer click
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block w-full max-w-3xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
          ...
          {/* Footer - UPDATED with Create Offer Button */}
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200">
            <div className="flex justify-between items-center">
              {/* Left side - Create Offer button (if applicable) */}
              <div>
                {canCreateOffer() && onCreateOffer && (
                  <button
