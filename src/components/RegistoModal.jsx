...
export default function RegistoModal({ isOpen, onClose, planoSelecionado }) {
    ...
    const [etapa, setEtapa] = useState(1); // 1: dados, 2: sucesso
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await signup(formData.email, formData.password, {
                ...
                plano: planoSelecionado?.nome || 'Professional'
            });

            setEtapa(2); // Mostrar sucesso
        } catch (error) {
                    ...
                    <>
                        ...
                        <div className="flex justify-between items-center p-6 border-b border-gray-700">
                            <div>
                                ...
                                <p className="text-gray-400">Plano: {planoSelecionado?.nome}</p>
                            </div>
                            <button
                                onClick={onClose}
                                ...
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <button
                                            ...
                                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-300"
                                        >
                                            {mostrarConfirmPassword ? <EyeSlashIcon className="w-5 h-5" /> : <EyeIcon className="w-5 h-5" />}
                                        </button>
                                    </div>
                                </div>
